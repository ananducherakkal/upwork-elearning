...
function FooterBottomSection() {
  return (
    <div className="mt-10 flex flex-wrap items-center justify-center">
      <div className="text-base space-x-8 flex flex-wrap mt-10 justify-center">
        <div>Tareeq@2024</div>
        <div>Terms of service</div>
        <div>Privacy policy</div>
        <div>Manage Cookies</div>
      </div>
      <div className="space-x-4 flex-wrap mx-auto md:mr-0 mt-10">
      ...
      <div className="flex md:ml-12 space-x-3 mt-10">
        <button className="w-fit outline-none active:opacity-80 border border-gray-40 rounded-md">
          <Image
            ...
            width="150"
            height="45"
            className="w-full md:w-[150px] h-fit md:h-[45px] object-contain"
          />
        </button>
        <button className="w-fit outline-none active:opacity-80 border border-gray-40 rounded-md">
          <Image
